<template>
    ...
    <div class="lottery" :body-padding-bottom="0">
        <div class="content" id="lottery-content">
            ...
            <img src="../../static/images/lottery/zhongqiu2018/bg.webp" class="bg-img">
            <marquee class="gamer-list" v-show="records.length > 0">
        ...
        methods: {
            ...
            handleBtnClick(app, e) {
                ...
                if (window.jsObj) {
                    ...
                    if (app.action === 'get') { //--获取抽奖机会
                    ...
                    } else { //初始化的istatus 0(未安装)和1(已经安装), 安装 升级 继续 action 记录一下app按钮 改成2(可领取)
                        if (!(app.action === 'open')) {
                            this.apps = this.apps.map(v => {
                                if (app.id === v.id) {
                                    return {
                        ...
                        app.action && JsCallApp.handleAppAction(JSON.stringify(app), app.action);
    ...
    .lottery {
        ...
        .img-c {
            ...
            .item-bg {
                ...
                left: 0;
                z-index: 12;
                background-image: url(../../static/images/lottery/zhongqiu2018/icon-bg.webp);
                background-repeat: no-repeat;
